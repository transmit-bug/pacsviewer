...
export function WorkspaceToolbar({ studyId }: WorkspaceToolbarProps) {
  ...
  return (
    <div
      data-tour="viewer-toolbar"
      className="glass-surface absolute bottom-3 left-1/2 z-30 flex -translate-x-1/2 items-center gap-1 rounded-md border border-white/10 px-2 py-1.5 shadow-lg"
    >
